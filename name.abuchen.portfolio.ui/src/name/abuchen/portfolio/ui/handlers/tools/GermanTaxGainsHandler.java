...
import name.abuchen.portfolio.ui.dialogs.vorabpauschale.GermanTaxGainsDialog;
import name.abuchen.portfolio.ui.handlers.MenuHelper;

public class GermanTaxGainsHandler
{
    @CanExecute
                    ...
                    @Named(IServiceConstants.ACTIVE_SHELL) Shell shell)
    {
        MenuHelper.getActiveClientInput(part).ifPresent(input -> {
            ...
            new GermanTaxGainsDialog(shell, input.getClient(), converter).open();
        });
    }
}
